...
const About = () => {
    const [state] = React.useState({heading: 'Who we are?', text: 'We are developing the sites by different ways like for single page applications and also as reponsive as this one  where we try to make user friendly sites'});
    const [sections] = React.useState([
      ...
      </svg>, heading: 'Digital Marketing', text: 'Where we fixes the issue for existing one and also involve in enhancementes activity also'},
    ...
    </svg>, heading: 'Web and web development', text: 'Its our passion to develop such reactive and responsive websites'},
  ...
  </svg>, heading: 'Graphics desing', text: 'Design is such userfriendly that make you easy way to go steps'}
    ]);
    return (
        <div className="about">
